...
describe("getRelationshipMeta", () => {
    test("should return undefined if no directive found", () => {
        ...
        const result = get_relationship_meta_1.default(field);
    ...
    test("should throw direction required", () => {
        ...
        expect(() => get_relationship_meta_1.default(field)).toThrow("@relationship direction required");
    });
    test("should throw direction not a string", () => {
        ...
        expect(() => get_relationship_meta_1.default(field)).toThrow("@relationship direction not a enum");
    });
    test("should throw direction invalid", () => {
        ...
        expect(() => get_relationship_meta_1.default(field)).toThrow("@relationship direction invalid");
    });
    test("should throw type required", () => {
        ...
        expect(() => get_relationship_meta_1.default(field)).toThrow("@relationship type required");
    });
    test("should throw type not a string", () => {
        ...
        expect(() => get_relationship_meta_1.default(field)).toThrow("@relationship type not a string");
    });
...
//# sourceMappingURL=get-relationship-meta.test.js.map