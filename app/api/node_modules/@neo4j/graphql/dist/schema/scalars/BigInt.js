...
exports.default = new graphql_1.GraphQLScalarType({
    ...
    parseValue(value) {
        if (typeof value !== "string") {
            throw new Error("BigInt values are not JSON serializable. Please pass as a string in variables, or inline in the GraphQL query.");
        }
    ...
    parseLiteral(ast) {
        switch (ast.kind) {
            ...
            case graphql_1.Kind.STRING:
                return neo4j_driver_1.int(ast.value);
            default:
