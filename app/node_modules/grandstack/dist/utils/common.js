...
exports.checkGHRef = exports.checkCredentials = exports.arrayOfFiles = exports.getEncryptionKeyString = exports.getNeo4jDatabaseString = void 0;
...
exports.getNeo4jDatabaseString = getNeo4jDatabaseString;

const getEncryptionKeyString = encrypted => {
  return encrypted ? ", {encrypted: 'ENCRYPTION_ON'}" : "";
};

exports.getEncryptionKeyString = getEncryptionKeyString;
...
const server = new ApolloServer({ schema, context: ${getNeo4jDatabaseString(database)} });
...
const packageLockJsonContents = (0, _file.getPackageLockJson)();
...
const checkCredentials = (neo4j_uri, neo4j_user, neo4j_password) => {
...
const checkGHRef = (repoName, repoOwner) => {
